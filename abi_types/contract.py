...
# Creating payment amount varible to = 1 Algo
PAYMENT_AMT = Int(1000000) #1 million microAlgos = 1 Algo

@router.method
# Creating pay method, takes in abi account as receiver and  outputs abi address
...
@router.method 
# Creatin fund method, passing in txn Type assinging to payment arg
def fund(payment: abi.PaymentTransaction):
    return Seq(
        # All txn types have a .get method
